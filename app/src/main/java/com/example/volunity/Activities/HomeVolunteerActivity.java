...
import com.example.volunity.databinding.ActivityHomeVolunteerBinding;
...
public class HomeVolunteerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_home_volunteer);
